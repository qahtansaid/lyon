...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("IPHONE 5S 32 GB ");
        mListMenu.add("SAMSUNG GALAXY A3 ");
        mListMenu.add("SAMSUNG GALAXY A5 ");
        mListMenu.add("OPPO F1 S+ ");
        mListMenu.add("SAMSUNG GALAXY NOTE 4");
    ...
    public void onClickOrder(View view) { //hanya memilih salah satu radiobox dan mendapatkan text untuk item
        ...
        String message = "Saya pesan HP Tipe : "
    ...
    public void onClickPlus(View view) {
        harga = harga + 5999999; //logic tombol >
        qty = qty + 1;
